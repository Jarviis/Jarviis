  ...
  describe('Collection', function() {
    ...
    describe('List Controller', function() {
      it('should be defined,', function() {
        expect(Jarviis.Issues.List.Controller).toBeDefined();
      });
      it('contain the correct functions', function() {
        expect(_.keys(Jarviis.Issues.List.Controller).length).toEqual(1);
        expect(Jarviis.Issues.List.Controller.listIssues).toBeDefined();
      });
      it('', function() {
